...
export async function createUser(email: User["email"], password: string, businessName: User["businessName"], phone: User["phone"],
                                 address: User["address"], taxInfo: User["taxInfo"], bankBalance: User['bankBalance'],
